...
_AWARENESS_TIME = 51000. * awareness_factor  # 1.6 minutes limit without user touching steering wheels make the car enter a terminal status
...
_DISTRACTED_TIME = 50000. * awareness_factor
